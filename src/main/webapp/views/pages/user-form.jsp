                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="ACTIVE" ${userForm.status == 'ACTIVE' or empty userForm.status ? 'selected' : ''}>Hoạt động</option>
                                        <option value="INACTIVE" ${userForm.status == 'INACTIVE' ? 'selected' : ''}>Ngừng hoạt động</option>
                                        <option value="BANNED" ${userForm.status == 'BANNED' ? 'selected' : ''}>Bị khóa</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
